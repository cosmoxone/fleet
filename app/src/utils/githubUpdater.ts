...
export class GitHubUpdater {
  private readonly owner = process.env.GITHUB_OWNER || 'fleet';
  private readonly repo = process.env.GITHUB_REPO || 'fleet';
  private readonly bundleName = process.env.FLEET_BUNDLE_NAME || 'Fleet';
