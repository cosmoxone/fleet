...
// prettier-ignore
export type LanguageSetting = 'system' | 'en' | 'zh-CN' | 'zh-TW';
...
export interface Settings {
  ...
  // Fleet nodes: each entry can be picked per chat window (New Chat on Node…).
  externalBackends: FleetNodeConfig[];
