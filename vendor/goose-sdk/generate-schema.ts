...
// Vendored schema inputs (snapshotted from goose crates/goose, baseline f4066f1).
const SCHEMA_PATH = resolve(__dirname, "acp-schema.json");
const META_PATH = resolve(__dirname, "acp-meta.json");
